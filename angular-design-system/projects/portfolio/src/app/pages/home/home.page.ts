...
import { getPortfolioHomeContent } from '../../content/home-content.registry';
...
export class HomePage {
  ...
  protected readonly content = computed(() => getPortfolioHomeContent(this.localeService.locale()));
